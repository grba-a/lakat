...
export const DRINK_TYPES = [
  ...
  { key: "kava", label: "Kava", emoji: "☕" },
  { key: "rakija", label: "Rakija", emoji: "⚡" },
  // "sot" i "vino" su maknuti iz ponude (rakija/gemišt ih pokrivaju; kava
  // je uzela vinovo mjesto) — ključevi i dalje postoje u DB check
  // constraintu zbog starih redova; drinkInfo() za njih vraća null
...
export async function fetchAllDrinks(supabase, userId, sinceIso) {
  const PAGE = 1000;
  const all = [];
