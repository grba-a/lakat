...
export async function updateSession(request) {
  ...
  // email iz claimova treba proxyju za lockdown allowlist; nema ga u
  // starim tokenima → tretira se kao "nije dopušten" (fail closed)
  return {
    response,
    user: claims ? { id: claims.sub, email: claims.email ?? null } : null,
  };
}
