...
export function koloPushBody(ime, pice) {
  return pick([
    `Kolo je presudilo: ${ime} večeras pije ${pice}. Nema žalbe.`,
    `Sudbina je rekla svoje — ${ime} pije ${pice}. Tko ne vjeruje, nek dođe provjerit.`,
    `${ime} je zavrtio kolo i dobio ${pice}. Smijeh je dozvoljen, čak i poželjan.`,
  ]);
}
